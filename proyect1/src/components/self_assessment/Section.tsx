...
const MantSection: React.FC<MantSectionProps> = ({
  ...
  return (
    <div className="grid grid-cols-6 bg-gray-800">
      ...
      <div className="border border-gray-700 flex items-center justify-center"></div>
      <div className="border border-gray-700 flex items-center justify-center"></div>
      <div className="border border-gray-700 flex items-center justify-center"></div>
      <div className="border border-gray-700 flex items-center justify-center"></div>
      ...
      <Checkbox
        onChange={(checked) => handleCheckboxChange(checked, 2)}
        checked={checkboxes[2]}
      />
      <Checkbox
        onChange={(checked) => handleCheckboxChange(checked, 3)}
        checked={checkboxes[3]}
      />
      <TextArea id={`Re.${number}.1`} className="w-auto" />

      <TextArea id={`Ob.${number}.1`} className="w-auto" />
      ...
      <Checkbox
        onChange={(checked) => handleCheckboxChange(checked, 4)}
        checked={checkboxes[4]}
      />
      <Checkbox
        onChange={(checked) => handleCheckboxChange(checked, 5)}
        checked={checkboxes[5]}
      />
      <TextArea id={`Re.${number}.2`} className="w-auto" />

      <TextArea id={`Ob.${number}.2`} className="w-auto" />
      ...
      <Checkbox
        onChange={(checked) => handleCheckboxChange(checked, 6)}
        checked={checkboxes[6]}
      />
      <Checkbox
        onChange={(checked) => handleCheckboxChange(checked, 7)}
        checked={checkboxes[7]}
      />
      <TextArea id={`Re.${number}.3`} className="w-auto" />

      <TextArea id={`Ob.${number}.3`} className="w-auto" />
      ...
      <Checkbox
        onChange={(checked) => handleCheckboxChange(checked, 8)}
        checked={checkboxes[8]}
      />
      <Checkbox
        onChange={(checked) => handleCheckboxChange(checked, 9)}
        checked={checkboxes[9]}
      />

      <TextArea id={`Re.${number}.4`} className="w-auto" />

      <TextArea id={`Ob.${number}.4`} className="w-auto" />
    </div>
  );
};
