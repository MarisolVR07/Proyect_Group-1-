    ...
    return (
        <footer className="text-white bg-black bg-opacity-30 body-font mt-auto">
            <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p className="text-md text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2024 Institution —
                    <a href="Email" className="text-gray-300 ml-1" target="_blank" rel="noopener noreferrer">Email</a>
                </p>
